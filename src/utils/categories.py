...
SUBCATEGORIES = {
    ...
    "Запрос на печать": CategoryInfo(
        image="assets/images/other.jpg",
        text=(
            "Если тебе необходимо распечатать материал — подробно распиши как именно это сделать. "
            ...
            "3. Цветная печать или чб?\n"
            "4. К какому времени необходимо распечатать данные материалы? В каком корпусе будет удобно их забрать?\n"
